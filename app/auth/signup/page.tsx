...
export default function SignupPage() {
    ...
    const validate = () => {
        ...
        if (password !== passwordCheck) errs.passwordCheck = "비밀번호가 일치하지 않습니다.";
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const fullAddress = addressDetail ? `${addressBase} ${addressDetail}` : addressBase;
                ...
                <div className="w-full max-w-md rounded-2xl p-10 shadow-[0_0_0_4px_rgba(253,224,71,0.25)]">
                   ...
                   hover:bg-amber-500 disabled:opacity-50 disabled:cursor-not-allowed"
                    ...
                    <div className="mt-6 text-center">
                        <Link href="/auth/login" className="text-sm text-amber-400 hover:underline">
                            이미 계정이 있으신가요? 로그인
                        </Link>
                    </div>
                </div>
