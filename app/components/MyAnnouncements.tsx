...
interface AnnouncementListItem {
    ...
    health: "HEALTHY" | "NORMAL" | "UNDER_TREATMENT" | "WEAK";
    personality: string;
}
...
const animalTypeKo: Record<"DOG" | "CAT", string> = {
    DOG: "강아지",
    CAT: "고양이",
};

const genderKo: Record<"MALE" | "FEMALE" | "UNKNOWN", string> = {
    MALE: "수컷",
    FEMALE: "암컷",
    UNKNOWN: "미상",
};

const healthKo: Record<"HEALTHY" | "NORMAL" | "UNDER_TREATMENT" | "WEAK", string> = {
    HEALTHY: "건강함",
    NORMAL: "보통",
...
const statusKo: Record<"OPEN" | "IN_PROGRESS" | "COMPLETED" | "CLOSED", string> = {
    OPEN: "공고 중",
    IN_PROGRESS: "입양 진행중",
    COMPLETED: "입양 완료",
    CLOSED: "종료",
...
const statusColor: Record<"OPEN" | "IN_PROGRESS" | "COMPLETED" | "CLOSED", string> = {
    OPEN: "bg-lime-500",
...
export default function MyAnnouncementsPage() {
    const [myAnnouncements, setMyAnnouncements] = useState<AnnouncementListItem[]>([]);
    ...
    async function fetchMyAnnouncements() {
        try {
            const res = await api.get<AnnouncementPageResponse>("/v1/announcements");
    ...
    async function fetchAnnouncementDetail(announcementId: number) {
        try {
        ...
        if (selectedAnnouncement) {
            setFormData({
                endDate: selectedAnnouncement.endDate
                    ? selectedAnnouncement.endDate.slice(0, 16)
                    : "",
    ...
    function handleOpenModal(announcementId: number) {
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-gray-600">
                                    ...
                                    <span className="text-gray-700">
                                        {genderKo[item.gender] || item.gender}
                                    </span>
                                </p>
                                <p className="text-xs text-gray-600">
                                    건강:{" "}
                                    <span className="text-gray-700">
                                        {healthKo[item.health] || item.health}
                                    </span>
                                </p>
                            </div>
                                ...
                                <div className="p-8">
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <div className="flex items-center mb-2">
                                            <p className="text-orange-500 text-xl font-semibold">
                                                {animalTypeKo[selectedAnnouncement.animalType] ||
                                                    selectedAnnouncement.animalType}
                                            </p>
                                            {!isEditMode && (
                                                <span
                                                    className={`ml-auto px-4 py-2 ${
                                                        statusColor[
                                                            selectedAnnouncement.announcementStatus
                                                        ]
                                    ...
                                    <div className="space-y-3 mb-8">
                                        ...
                                        <div className="flex items-center border-b border-gray-200 pb-3">
                                            ...
                                            <span className="text-gray-700 text-sm">
                                                {genderKo[selectedAnnouncement.gender] ||
                                        ...
                                        <div className="flex items-center border-b border-gray-200 pb-3">
                                            ...
                                            <span className="text-gray-700 text-sm">
                                                {healthKo[selectedAnnouncement.health] ||
                                                    selectedAnnouncement.health}
                                            </span>
                                        </div>
                                        ...
                                        <div className="flex items-center border-b border-gray-200 pb-3">
                                            ...
                                            <span className="text-gray-700 text-sm">
                                                {selectedAnnouncement.shelterName}
                                            </span>
                                        </div>
