        ...
        <div className="space-y-10 border-b border-gray-300 pb-6">
            ...
            {isReadOnly ? (
                <div className="space-y-6">
                    <div>
                        <p className="text-base font-semibold text-amber-700 mb-1">월 양육비</p>
                        <p className="text-sm text-gray-800">{financialInfo.monthlyBudgetLabel || "-"}</p>
                    </div>
                    <div>
                        <p className="text-base font-semibold text-amber-700 mb-1">긴급 자금</p>
